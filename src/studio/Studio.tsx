...
export default function Studio() {
  ...
  return <div className="studio">
    ...
    <main id="studio-main" className="st-main">
      ...
      <footer className="st-footer"><span>Learn the system by changing it.</span><a href="/guide">Open the original field guide <ArrowRight size={13} /></a></footer>
    </main>
